...
public class GenericDialog
{
     ...
     * @return the widget of the text field
     */
    public JTextField addNumericField(String label, double defaultValue, int digits, int columns,
            String units)
    {
...
//          defaultText = new Vector(5);
    ...
    public JCheckBox addCheckBox(String label, boolean defaultValue)
    {
        ...
        // if (!isPreview && (Recorder.record || macro)) // preview checkbox is
        // not
        // // recordable
        // saveLabel(cb, label);
        currentRow++;
...
//                else
    ...
    /**
     * Adds a combo box that contains different choices, using a list of enums.
     * 
     * Code example:
     * 
     * <pre>
     ...
     * @return the widget of the combo box
     */
    public <E extends Enum<E>> JComboBox<String> addChoice(String label, EnumSet<E> items,
            E defaultItem)
    {
    ...
    public JScrollBar addSlider(String label, double minValue, double maxValue, double defaultValue)
    {
        ...
        if ((maxValue - minValue) <= 5.0 && (minValue != (int) minValue
                || maxValue != (int) maxValue || defaultValue != (int) defaultValue))
        {
            scale = 20.0;
            minValue *= scale;
            maxValue *= scale;
        ...
        JScrollBar scrollBar = new JScrollBar(JScrollBar.HORIZONTAL, (int) defaultValue, 1,
    ...
    /**
     * Create text filed for numbers. Adds some pre-pressing on the number of
     * columns.
     */
    ...
    public String getNextString()
    {
        ...
        // String s = theText;
        // if
        // (s!=null&&s.length()>=3&&Character.isLetter(s.charAt(0))&&s.charAt(1)==':'&&s.charAt(2)=='\\')
        // s = s.replaceAll("\\\\", "\\\\\\\\"); // replace "\" with "\\" in
        // Windows file paths
        // recordOption(tf, s);
        // }
...
//          recordOption(thisChoice, item);
    ...
    public int getNextChoiceIndex()
    {
        ...
        // if (s==null)
        // IJ.error(getTitle(), "\""+item+"\" is not a valid choice for
        // \""+label+"\"");
        // else
        // item = s;
        // }
