...
public class TableFrameMenuBuilder extends FrameMenuBuilder
{
    ...
    private JMenu createEditMenu()
    {
        ...
        addPlugin(editMenu, imago.table.plugins.edit.RenameTable.class, "Rename...");
        editMenu.addSeparator();
        addPlugin(editMenu, imago.table.plugins.edit.TableSelectColumns.class, "Select Columns...");
        addPlugin(editMenu, imago.table.plugins.edit.TableKeepNumericColumns.class, "Keep Numeric Columns");
        addPlugin(editMenu, imago.table.plugins.edit.ConcatenateTableColumns.class, "Concatenate Columns...");
        addPlugin(editMenu, imago.table.plugins.edit.TableParseGroupFromRowNames.class, "Parse Group From Row Names...");
        editMenu.addSeparator();
        addPlugin(editMenu, imago.table.plugins.edit.TableFilterRows.class, "Filter/Select Rows...");
        addPlugin(editMenu, imago.table.plugins.edit.TableSortRows.class, "Sort Rows...");
        addPlugin(editMenu, imago.table.plugins.edit.ConcatenateTableRows.class, "Concatenate Rows...");
        editMenu.addSeparator();
        addPlugin(editMenu, imago.table.plugins.edit.TransposeTable.class, "Transpose");
        editMenu.addSeparator();
        addPlugin(editMenu, imago.table.plugins.edit.FoldTableToImage.class, "Fold Table to Image");
        editMenu.addSeparator();
        addPlugin(editMenu, imago.table.plugins.edit.PrintTableInfo.class, "Print Table Info");
        addPlugin(editMenu, imago.table.plugins.edit.NumericTableSummary.class, "Table Summary");
        addPlugin(editMenu, imago.table.plugins.edit.PrintTableToConsole.class, "Print to Console");
    ...
    private JMenu createProcessMenu()
    {
        ...
        addPlugin(processMenu, imago.table.plugins.process.ApplyFunctionToColumn.class, "Apply Function to Columns...");
        processMenu.addSeparator();
        addPlugin(processMenu, imago.table.plugins.process.AggregateTableWithColumn.class, "Aggregate by group...");
        processMenu.addSeparator();
        addPlugin(processMenu, imago.table.plugins.process.TablePca.class, "Principal Components Analysis");
        processMenu.addSeparator();
        addPlugin(processMenu, imago.table.plugins.process.TableKMeans.class, "K-Means...");
        processMenu.addSeparator();
        addPlugin(processMenu, imago.table.plugins.process.TableConfusionMatrix.class, "Confusion Matrix...");
        processMenu.addSeparator();
        addPlugin(processMenu, imago.table.plugins.process.CreateLabelClassMap.class, "Create Label Class Map...");
