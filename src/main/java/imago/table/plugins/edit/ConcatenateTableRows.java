...
/**
 * Creates a new table based on the concatenation of the rows of two input
 * tables.
 * 
 * @author dlegland
 *
 */
public class ConcatenateTableRows implements FramePlugin
{
    ...
    public void run(ImagoFrame frame, String args)
    {
        ...
        {
            throw new RuntimeException("Both tables must have same number of columns");
        }
